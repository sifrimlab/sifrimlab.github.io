---
title: New PhD position open on AI-driven multimodal data fusion models in rare diseases
tags:
  - job
last_modified_at: ""
---
...
<!-- excerpt start -->
<!-- excerpt end -->
Come join our team! PhD position open as part of an international Marie Skłodowska-Curie Doctoral Network SPACE-MEL (101311007).

The problem is to train meaningful predictive models that can work in scenarios where training data is limited (as is by definition the case in rare disease). We have some ideas on how to do this, we need someone to help us out. If you're up for a challenge, don't hesitate to apply.
